...
DATASET_PATH = "hf://datasets/tourism_package_predictor/tourism-package-prediction-analysis/tourism.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="tourism_package_predictor/tourism-package-prediction-analysis",
        repo_type="dataset",
    )
